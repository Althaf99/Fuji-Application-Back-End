...
public class StockQueryController {
    ...
    public PageResponse<StockRow> list(@RequestParam(required = false) ItemType itemType,
            @RequestParam(required = false) Long itemId, @RequestParam(required = false) Long vendorId,
        ...
        return service.list(itemType, itemId, vendorId, from, to, lowStock, page, size, sort, direction);
    }
